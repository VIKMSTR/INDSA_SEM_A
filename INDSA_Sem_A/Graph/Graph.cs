...
{
    [Serializable]
    public class Graph : IGraph<string,LinkedList<Follower>> //implementace IGrafu - klíèe jsou stringy, followery jsou v seznamu
    {
        public Dictionary<string, INode> Nodes; // klíèem je string, hodnotou je objekt typu INode  (IVrchol)
        ...
        public void AddNewEdge(INode from , INode to)
        {
            ...
            if (from.Equals(to))
            {
                throw new LoopEdgeException("Nelze vložit hranu - smyèku");
            }
        ...
        public INode RemoveNode(string key)
        {
            ...
            {
                throw new InvalidKeyException("Prázdný klíè");
            }
        ...
        {
            //TODO: dodìlat getnutí všech prvkù 
